...
filename = os.path.join(
    current_dir,
    "../../data/model_weights/v4_resnet_data_driven/resnet_data_driven_1.pth.tar",
)
state_dict = torch.load(filename)

# load single model
v4_resnet_data_driven = model_fn(
    seed=0,
    dataloaders=None,
    **model_config,
    data_info=data_info,
)
v4_resnet_data_driven.load_state_dict(state_dict)
