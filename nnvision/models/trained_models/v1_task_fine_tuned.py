...
from ..ptrmodels import convnext_core_gauss_readout
...
filename = os.path.join(
    current_dir, "../../data/model_weights/v1_task_fine_tuned/v1_convnext_1.pth.tar"
)
state_dict = torch.load(filename)

# load single model - V1
v1_convnext = model_fn(
    seed=0,
    dataloaders=None,
    **model_config,
    data_info=data_info,
)
v1_convnext.load_state_dict(state_dict)
...
filename = os.path.join(
    current_dir,
    "../../data/model_weights/v1_task_fine_tuned/color/convnext_v1_color_1.tar",
)
state_dict = torch.load(filename)

# load single model - V1
color_v1_convnext = model_fn(
    seed=0,
    dataloaders=None,
    **model_config,
    data_info=data_info,
